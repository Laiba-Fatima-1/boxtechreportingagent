...
export const ACCENT_CLASS = {
  brand: { dot: "bg-brand", soft: "bg-brand-soft", text: "text-brand" },
  blue: { dot: "bg-blue", soft: "bg-blue-soft", text: "text-blue" },
  purple: { dot: "bg-purple", soft: "bg-purple-soft", text: "text-purple" },
  amber: { dot: "bg-amber", soft: "bg-amber-soft", text: "text-amber" },
  red: { dot: "bg-red", soft: "bg-red-soft", text: "text-red" },
};

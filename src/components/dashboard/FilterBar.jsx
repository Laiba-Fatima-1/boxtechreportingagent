  ...
  return (
    <div ref={rootRef} className="filter-shell px-3 py-3 sm:px-4">
      ...
      <div className="flex flex-wrap items-center gap-2.5">
        ...
        <div className="scroll-slim -mx-1 min-w-0 flex-1 overflow-x-auto px-1">
          <div
            role="tablist"
            aria-label="Date range"
            className="seg-track grid w-max min-w-full grid-cols-5 gap-0 rounded-[14px] bg-canvas/80 p-1"
          >
            <span
              className="seg-thumb"
              style={{
            ...
            {DATE_PRESETS.map((d) => {
              ...
              return (
                <button
                  ...
                  className={`relative z-10 whitespace-nowrap rounded-[11px] px-3 py-1.5 text-[12px] font-semibold transition-colors duration-200 ${
        ...
        <button
          ...
          className="press inline-flex h-8 shrink-0 items-center gap-1.5 rounded-xl border border-line bg-white/70 px-2.5 text-[12px] font-medium text-ink-soft transition-colors hover:bg-white hover:text-ink disabled:opacity-40 disabled:hover:bg-white/70"
        >
